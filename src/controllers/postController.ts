...
const postCtrl = {
  ...
  createPost: async (req: Request, res: Response) => {
    ...
    try{
        const validatedRequestBody: IPost = postValidation.CreatePostSchema(req.body);
  ...
  updatePost: async (req: Request, res: Response) => {
    try{
        const validatedRequestBody: IPost = postValidation.CreatePostSchema(req.body);
        const post = await Post.findByIdAndUpdate(req.params.postId, validatedRequestBody, {new: true});
